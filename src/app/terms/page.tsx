  ...
  return (
    <main className={styles.shell}>
      ...
      <article className={styles.document}>
        ...
        <section className={styles.section}><h2>AI and third-party services</h2><p>The service depends on Vercel, Supabase, GitHub when selected for OAuth, email delivery used by Supabase Auth, and NVIDIA NIM/model infrastructure. Their terms and availability also apply to their services. No affiliation, certification, or partnership with Telegram, Instagram, WhatsApp, NVIDIA, GitHub, Supabase, Vercel, Kimi, or OpenClaw is claimed unless explicitly stated elsewhere with evidence.</p></section>
